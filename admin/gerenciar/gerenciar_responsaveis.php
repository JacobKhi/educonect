                    ...
                    <form action="gerenciar_responsaveis.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_responsavel" name="id_responsavel" required>
                                <option value="">-- Selecione --</option>
                                <?php if($result_responsaveis) { while($responsavel = $result_responsaveis->fetch_assoc()): ?>
                                            ...
                                            <?php foreach ($vinculos as $vinculo): ?>
                                                <tr>
                                                    ...
                                                    <td class="actions-cell">
                                                        <a href="gerenciar_responsaveis.php?acao=desvincular&id_aluno=<?php echo $vinculo['id_aluno_usuario']; ?>&id_responsavel=<?php echo $vinculo['id_responsavel_usuario']; ?>" class="btn btn-small btn-delete">Desvincular</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
