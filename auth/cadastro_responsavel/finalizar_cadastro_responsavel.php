...
if (isset($_SESSION['cadastro_error'])) {
    $mensagem_erro = $_SESSION['cadastro_error'];
...
<head>
    <meta charset="UTF-8">
    <title>Finalizar Cadastro de Responsável</title>
...
<body class="center-layout">
    <div class="form-container">
        <h2>Primeiro Acesso - Responsável</h2>
        <p style="text-align: center; margin-bottom: 20px;">Insira o código de cadastro que você recebeu.</p>
        
        <form action="validar_codigo_responsavel.php" method="post">
             <?php
